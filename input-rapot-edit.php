...
<div class='container'>
<h1>Edit Data</h1>
<form action="input-rapot-edit.php" method="POST">
    ...
    <a class="btn btn-sm btn-secondary" href="input-rapot.php">Kembali</a>
</form>
</div>
...
<?php
    ...
    $update = mysqli_query($mysqli, $query);
        ...
        echo "
            <script>
            alert('Data gagal');
            window.location='input-rapot-edit.php?nis=$nis';
            </script>
        ";
        }
    }
